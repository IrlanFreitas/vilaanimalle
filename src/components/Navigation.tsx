...
const WHATSAPP_URL =
  "https://wa.me/5571982021139?text=Ol%C3%A1!%20Gostaria%20de%20agendar%20uma%20consulta%20na%20Vila%20Animalle.";

const links = [
  { to: "/", label: "Início", external: false },
  { to: "/servicos", label: "Serviços", external: false },
  {
    to: "https://www.petz.com.br/parceiro/dramarianaboulhosa",
    label: "Produtos",
    external: true,
  },
  { to: "/sobre", label: "Sobre", external: false },
