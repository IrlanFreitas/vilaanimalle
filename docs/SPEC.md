# Spec.md - Vila Animalle Pet Care
...
*(Mais perguntas serão adicionadas após validação com Dra. Mariana — meta: 5-8 perguntas)*
...
export function ServiceCard({ icon, title, description, ctaText, ctaHref, isExternal }: ServiceCardProps) {
